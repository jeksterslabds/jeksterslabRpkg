...
<!-- badges: start -->
[![Travis build status](https://travis-ci.org/jeksterslabds/jeksterslabRpkg.svg?branch=master)](https://travis-ci.org/jeksterslabds/jeksterslabRpkg)
...
It also includes other package related functions.
...
See [GitHub Pages](https://jeksterslabds.github.io/jeksterslabRpkg/)
